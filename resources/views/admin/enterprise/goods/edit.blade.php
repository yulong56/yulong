    ...
    <div class="page-container">
        <form class="form form-horizontal" id="form-edit">
            ...
            <div class="row cl hidden">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>企业商品id：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="id" name="id" type="text" class="input-text"
                           value="{{ isset($data->id) ? $data->id : '' }}" placeholder="企业商品id">
                </div>
            </div>
            <div class="row cl hidden">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    ...
                    <select id="goods_id" name="goods_id" class="select" size="1">
                        @foreach($goods as $good)
                            <option value="{{$good->id}}" {{$good->id == $data->goods_id ? 'selected':''}}>{{$good->name}}</option>
                        @endforeach
                    </select>
                    </span>
                </div>
        ...
        $(function () {
            $("#form-edit").validate({
                ...
                submitHandler: function (form) {
                    $(form).ajaxSubmit({
                        type: 'POST',
                        url: "{{ URL::asset('/admin/enterprise/goods/edit')}}",
