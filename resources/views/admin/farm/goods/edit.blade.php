...
@section('content')
    ...
    <div class="page-container">
        <form class="form form-horizontal" id="form-edit">
            ...
            <div class="row cl hidden">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="id" name="id" type="text" class="input-text"
                           value="{{ isset($data->id) ? $data->id : '' }}" placeholder="农产品id">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="name" name="name" type="text" class="input-text"
                           value="{{ isset($data->name) ? $data->name : '' }}" placeholder="请输入农产品名称">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <span class="select-box" style="width: 250px;">
					    <select id="goods_type_id" name="goods_type_id" class="select" size="1">
                            @foreach($goodsTypes as $goodsType)
                                <option value="{{$goodsType->id}}" {{$goodsType->id == $data->goods_type_id ? 'selected':''}}>{{$goodsType->name}}</option>
                            @endforeach
                        </select>
                    </span>
                </div>
            ...
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>农产品图片：</label>
                <div id="container" class="formControls col-xs-8 col-sm-9">
                    <input id="img" name="img" type="text" class="input-text" style="width: 250px" readonly
                           value="{{ isset($data->img) ? $data->img : '' }}" placeholder="请选择农产品图片">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <div>
                        <img id="img_img"
                             ...
                             src="{{ $data->img ? $data->img.'?imageView2/1/w/200/h/200/interlace/1/q/75|imageslim' : URL::asset('/img/upload_rect.png')}}"
                             style="width: 150px;height: 150px;">
                    </div>
                    <div style="font-size: 12px;margin-top: 10px;" class="text-gray">*请上传150*150尺寸图片
                    </div>
                </div>
            </div>
        ...
        $(function () {
            ...
            $("#form-edit").validate({
                ...
                submitHandler: function (form) {
                    $(form).ajaxSubmit({
                        type: 'POST',
                        url: "{{ URL::asset('/admin/farm/goods/edit')}}",
