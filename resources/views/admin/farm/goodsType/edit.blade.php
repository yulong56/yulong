...
@section('content')
    ...
    <div class="page-container">
        <form class="form form-horizontal" id="form-edit">
            ...
            <div class="row cl hidden">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="id" name="id" type="text" class="input-text"
                           value="{{ isset($data->id) ? $data->id : '' }}" placeholder="农产品类型id">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>农产品类型名称：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="name" name="name" type="text" class="input-text"
                           value="{{ isset($data->name) ? $data->name : '' }}" placeholder="请输入农产品类型名称">
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>农产品类型图片：</label>
                <div id="container" class="formControls col-xs-8 col-sm-9">
                    <input id="img" name="img" type="text" class="input-text" style="width: 250px" readonly
                           value="{{ isset($data->img) ? $data->img : '' }}" placeholder="请选择农产品类型图片">
        ...
        $(function () {
            ...
            $("#form-edit").validate({
                ...
                submitHandler: function (form) {
                    $(form).ajaxSubmit({
                        type: 'POST',
                        url: "{{ URL::asset('/admin/farm/goodsType/edit')}}",
