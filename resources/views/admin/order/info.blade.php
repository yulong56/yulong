...
@section('content')
    ...
    <div class="page-container">
        ...
        <table class="table table-border table-bordered table-bg mt-20">
            ...
            <thead>
            <tr>
                <th scope="col" colspan="3">用户喜好信息</th>
            </tr>
            <tr class="text-c">
                <th width="100">农产品图片</th>
                <th width="100">农产品名称</th>
        ...
        <table class="table table-border table-bordered table-bg mt-20">
            ...
            <tr>
                ...
                <td>订单金额/数量</td>
                <td>{{isset($data->total_fee)?$data->total_fee:'--'}}/{{$data->goods_num}}</td>
            </tr>
            <tr>
                <td>订单描述</td>
            ...
            <tr>
                ...
                <td>
                    @if($data->order_type=="0")
                        {{isset($data->farm)?$data->farm->name:'--'}}
                        -{{isset($data->green_house)?$data->green_house->name:'--'}}
                        -{{isset($data->house_land)?$data->house_land->name:'--'}}
                    @endif
